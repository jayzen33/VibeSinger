...
from .autoencoders import AudioAutoencoder, create_autoencoder_from_config
...
class StableVAE(AbstractVAE):
    def __init__(self, vae_ckpt, vae_cfg, sr=48000) -> None:
        ...
        self.sample_rate = sr
        self.rsp48k = (
            torchaudio.transforms.Resample(sr, self.orig_sample_rate) if sr != self.orig_sample_rate else nn.Identity()
        )
